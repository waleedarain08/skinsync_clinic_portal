...
import 'package:skinsync_clinic_portal/screens/dashboard/home_screen.dart';
...
class AppSidebar extends StatelessWidget {
  ...
  List<SidebarXItem> _buildItems(BuildContext context) {
    return [
      SidebarXItem(icon: Iconsax.home_2, label: 'Home', onTap: () => _onItemTap(context, 0)),
      SidebarXItem(icon: Iconsax.profile_2user, label: 'Patient Management', onTap: () => _onItemTap(context, 1)),
      SidebarXItem(icon: Iconsax.calendar, label: 'Appointments', onTap: () => _onItemTap(context, 2)),
      SidebarXItem(icon: Icons.vaccines_outlined, label: 'Treatments', onTap: () => _onItemTap(context, 3)),
      SidebarXItem(icon: Icons.masks_outlined, label: 'Doctors / Injectors', onTap: () => _onItemTap(context, 4)),
      SidebarXItem(icon: Icons.inventory, label: 'Inventory', onTap: () => _onItemTap(context, 5)),
      SidebarXItem(icon: Icons.person_outline, label: 'Roles', onTap: () => _onItemTap(context, 6)),
      SidebarXItem(icon: Iconsax.user_octagon, label: 'Staff', onTap: () => _onItemTap(context, 7)),
      SidebarXItem(icon: Iconsax.wallet_3, label: 'Payments & Wallets', onTap: () => _onItemTap(context, 8)),
      SidebarXItem(icon: Iconsax.profile_circle, label: 'Profile', onTap: () => _onItemTap(context, 9)),
    ];
  }
  ...
  Widget _separatorBuilder(BuildContext context, int index, SidebarXController controller) {
    if (index == 2) return _SectionLabel(title: 'CLINICAL', controller: controller);
